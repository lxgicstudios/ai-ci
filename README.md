...
![npm](https://img.shields.io/npm/v/ai-ci)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-ci)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Continuous integration pipeline setup and automation toolkit

CI/CD pipeline generator. Creates optimized GitHub Actions workflows for any project type.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-ci.svg)](https://badge.fury.io/js/ai-ci)
